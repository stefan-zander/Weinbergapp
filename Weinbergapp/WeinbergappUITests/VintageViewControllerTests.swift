//
//  VintageViewControllerTests.swift
//  WeinbergappUITests
//
...
class VintageViewControllerTests: XCTestCase {
    ...
    func testAdd() {
        ...
        let execution = scrollView.pickerWheels["Händisch"]
        execution.tap()
        execution.adjust(toPickerWheelValue: "Mechanisch")
