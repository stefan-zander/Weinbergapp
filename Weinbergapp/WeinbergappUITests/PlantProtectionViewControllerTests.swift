//
//  PlantProtectionViewControllerTests.swift
//  WeinbergappUITests
//
...
class PlantProtectionViewControllerTests: XCTestCase {
    ...
    func testAdd() {
        ...
        let treatmentSchedule = scrollView.pickerWheels["Austrieb"]
        treatmentSchedule.tap()
        treatmentSchedule.adjust(toPickerWheelValue: "2. Vorblüte")
